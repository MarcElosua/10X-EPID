...
parser.add_argument("--spaceranger",
                    ...
                    action = "store",
                    default = None,
                    help = "Path to spaceranger software - /scratch/devel/melosua/phd/10x_software/spaceranger-1.1.0/spaceranger")
...
parser.add_argument("--reference_path",
                    ...
                    action = "store",
                    default = None,
                    help = "Path of folder containing 10x-compatible reference - /scratch/devel/melosua/phd/10x_software/refdata-gex-GRCh38-2020-A/")
